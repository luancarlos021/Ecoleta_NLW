...
{{- default .Chart.Name .Values.operator.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- $name := default .Chart.Name .Values.operator.fullnameOverride }}
...
*/}}
{{- define "fullname.hostname" -}}
{{- $host := .Values.hostname | quote }}
{{- if eq .Values.global.env "prod" -}}
{{- regexReplaceAll "^prod\\." $host "" | trimAll "\"" }}
{{- else -}}
{{ .Values.global.env }}.{{ $host | trimAll "\"" }}
{{- end -}}
{{- end -}}